...
int main() {
    ...
    std::vector<ShapeBase *> shapes{
        ...
        new Sphere(Vector3(0, -10004, 0), 10000, Vector3(), new Diffuse(Vector3(0.75))), // 下壁
        ...
        new Sphere(Vector3(0, 23.98, 2), 20, Vector3(12), new Diffuse(Vector3())), // ライト
        ...
        new Sphere(Vector3(0, 0, 4), 1, Vector3(), new Mirror(1)),
    };
    Scene scene(shapes, Vector3(0), 256, 100);
    CameraBase *camera = new PinholeCamera(img, Vector3(0, 0, -4), Vector3(), 1);
    Progress progress(img.size*scene.spp);
